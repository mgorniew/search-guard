...
public class IntegrationTests extends SingleClusterTest {
    ...
    public void testDNSpecials() throws Exception {
        ...
        final Settings settings = Settings.builder()
                .put(SSLConfigConstants.SEARCHGUARD_SSL_TRANSPORT_KEYSTORE_FILEPATH, FileHelper.getAbsoluteFilePathFromClassPath("node-untspec5-keystore."+(!utFips()?"p12":"BCFKS")))
        ...
        Settings tcSettings = Settings.builder()
                .put("searchguard.ssl.transport.keystore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("node-untspec6-keystore."+(!utFips()?"p12":"BCFKS")))
                .put(SSLConfigConstants.SEARCHGUARD_SSL_TRANSPORT_KEYSTORE_TYPE, "PKCS12")
                .build();
    ...
    public void testSgIndexSecurity() throws Exception {
        ...
        HttpResponse res = rh.executePutRequest("searchguard/_mapping?pretty", "{\"properties\": {\"name\":{\"type\":\"text\"}}}",
